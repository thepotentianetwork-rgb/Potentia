...
export function interiorPrice(kind, wf, df){
...
/* Sell rate per square foot, in whole cents, rounded UP to the nearest 5c.
   ...
   on the price sheet. */
export function flooringSellRateCents(tier){
...
export function flooringSellMinCents(tier){
...
export function flooringPrice(tier, areaSqft){
...
export function wallAreaFt(W,D,wallHft){ return 2*(W+D)*wallHObjFor(wallHft).heightFt; }
...
export function sellPerSqft(name, W, D, wallHft, customArea){
...
export const ROLLUP_COLOR_UPCHARGE = { white: 0, black: 100, brown: 100 };

export function sellDoorUpcharge(dd){
...
export function rollUpColorUpcharge(dd){
...
/* Which door styles come in a finish colour, and what each has always been
   ...
   actually quoted as. */
export const DOOR_COLOR_DEFAULTS = { rollup: 'white', fairytale: 'black' };
...
export function doorColorLabel(dd){
...
/* What the CUSTOMER reads on the quote line.
   ...
   quote says it is. */
export function doorDisplayName(dd){
...
export function sellWindowPrice(wd){
...
export function sidingDisplayName(id){
  var k = String(id || '');
